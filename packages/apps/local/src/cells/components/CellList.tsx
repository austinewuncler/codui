    ...
    <ul className="flex flex-col gap-4">
      ...
      <AnimatePresence>
        {cells.map(({ id }) => (
          ...
          >
            <article className="overflow-hidden rounded-r-lg rounded-b-lg">
              <header className="flex items-center justify-between bg-accent-light pr-4 dark:bg-accent-dark">
